                ...
                <div className=" py-8 px-4 shadow sm:rounded-lg sm:px-10">
                     ...
                     <div className="grid w-full max-w-sm items-center  py-5  ">
                         ...
                         <Input type="text" id="email" placeholder="Name" onChange={(e)=>setName(e.target.value)}/>
                            ...
                            <div className="grid w-full max-w-sm items-center  py-5  ">
                         <label className=" flex justify-start text-white">Rollno</label>
                                <Input type="text" id="email" placeholder="Rollno" onChange={(e) => setRollno(e.target.value)} />
                                
                            </div>
                            <div className="grid w-full max-w-sm items-center  py-5  ">
                         <label className=" flex justify-start text-white">year</label>
                         <Input type="text" id="email" placeholder="Year" onChange={(e)=>setYear(e.target.value)}/>
                            </div>
                            <div className="grid w-full max-w-sm items-center  py-5  ">
                         <label className=" flex justify-start text-white">Department</label>
                         <Input type="text" id="email" placeholder="department" onChange={(e)=>setDepartment(e.target.value)}/>
                            </div>
                            <br></br>
